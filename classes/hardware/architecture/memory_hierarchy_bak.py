    ...
    def __init__(self, operational_array: OperationalArray, name: str = "Memory Hierarchy", **attr):
        ...
        if operational_array.type in ['DIMC', 'AIMC']:
            if operational_array.type == 'DIMC':
                size_elem = operational_array.unit.cost['WEIGHT_BITCELL'] * operational_array.unit.cost['CORE_ROWS']
            else:
                size_elem = operational_array.unit.cost['WEIGHT_BITCELL']
            dim_div = {'D1':1, 'D2':size_elem}
            ...
            weight_cell = MemoryInstance(name="weight_cell", size=size_elem, r_bw=operational_array.unit.cost['WEIGHT_BITCELL'], w_bw=operational_array.unit.cost['WEIGHT_BITCELL'], 
                r_cost=0, w_cost=0.14, rw_port = 1, area=0)
